...
// Declare history array globally
let history = [];

// Display welcome message on page load
window.onload = function () {
	const welcomeMessage = "Hello! I'm AIVA, your AI Visual Art Investment guide. How can I help you navigate the world of AI art investments today?";
	history.push({ role: 'model', parts: [{ text: welcomeMessage }] });
...
document.querySelector('.chat-controls button:first-child').addEventListener('click', function () {
	...
	// Reset history and add welcome message
	history = [];
	const welcomeMessage = "Hello! I'm AIVA, your AI Visual Art Investment guide. How can I help you navigate the world of AI art investments today?";
	history.push({ role: 'model', parts: [{ text: welcomeMessage }] });
	addMessage(welcomeMessage, false);
